...
public class CreateCusFragment extends Fragment {
    ...
    public static String new_customer_id, new_customer_name;
    ...
    private void init(View mView) {
        ...
        pb_addProductProgress = mView.findViewById(R.id.pb_addProductProgress);
    ...
    private void callAddCustomerApi() {
        pb_addProductProgress.setVisibility(View.VISIBLE);
